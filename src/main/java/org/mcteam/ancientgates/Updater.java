...
public class Updater {
	...
	private static final String HOST = "https://api.curseforge.com"; // Slugs will be appended to
	                                                                 // this to get to the project's
	                                                                 // RSS feed

	private static final String[] NO_UPDATE_TAG = { "a", "b" }; // If the version number contains
	...
	public enum UpdateResult {
		...
		FAIL_DOWNLOAD, /**
		                ...
		                */
		FAIL_DBO, /**
		           * When running the version check, the file on DBO did not contain the a version
		           * in the format 'vVersion' such as 'v1.0'.
		           */
		FAIL_NOVERSION, /**
